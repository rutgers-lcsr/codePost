...
import { CommentsResponse, FeedbackScoreResponse, RubricComment } from "./types";
...
export const RubricComments = {
    ...
    getComments: async (rubricCommentId: number) => {
        return await CodePostHTTP.get<CommentsResponse>(`/rubricComments/${rubricCommentId}/comments/`);
    },
    getFeedbackScore: async (rubricCommentId: number) => {
        return await CodePostHTTP.get<FeedbackScoreResponse>(`/rubricComments/${rubricCommentId}/feedbackScore/`);
    },
};
